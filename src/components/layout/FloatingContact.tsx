...
export default function FloatingContact() {
  ...
  return (
    <div className="floating-contact fixed right-4 sm:right-6 z-50 flex flex-col items-end gap-2 transition-all duration-300" style={{ bottom: "max(1rem, calc(env(safe-area-inset-bottom) + 0.25rem))" }}>
