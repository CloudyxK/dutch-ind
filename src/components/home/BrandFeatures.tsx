const features = [
  {
    num: "01",
    title: "Gratis Ongkir",
    desc: "Pembelian di atas Rp500.000 ke seluruh Indonesia",
    symbol: "→",
  },
  {
    num: "02",
    title: "100% Original",
    desc: "Semua produk bergaransi keaslian penuh",
    symbol: "◆",
  },
  {
    num: "03",
    title: "Mudah Dikembalikan",
    desc: "Pengembalian gratis dalam 14 hari",
    symbol: "↺",
  },
  {
    num: "04",
    title: "Layanan 24/7",
    desc: "Tim siap membantu kapan saja via chat",
    symbol: "◈",
  },
];
